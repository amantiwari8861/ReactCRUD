                ...
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                    <div className="relative flex h-16 items-center justify-between">
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-4">
                                    <NavLink to="/" className={({ isActive }) => `rounded-md px-3 py-2 text-sm font-medium text-white ${isActive ? 'bg-gray-900' : 'hover:bg-gray-700 hover:text-white'} `} aria-current="page">Dashboard</NavLink>
                                    <NavLink to="/about" className={({ isActive }) => `rounded-md px-3 py-2 text-sm font-medium text-gray-300 ${isActive ? 'bg-gray-900' : 'hover:bg-gray-700 hover:text-white'} `}>about us</NavLink>
                                    <NavLink to="/contact" className={({ isActive }) => `rounded-md px-3 py-2 text-sm font-medium text-gray-300 ${isActive ? 'bg-gray-900' : 'hover:bg-gray-700 hover:text-white'} `}>contact us</NavLink>
                                    <NavLink to="/services" className={({ isActive }) => `rounded-md px-3 py-2 text-sm font-medium text-gray-300 ${isActive ? 'bg-gray-900' : 'hover:bg-gray-700 hover:text-white'} `}>services</NavLink>
                                </div>
                            </div>
                        </div>
                        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                            ...
                            <Link to={"/login"}><button className="bg-green-600 rounded p-2 px-4">login</button></Link>
